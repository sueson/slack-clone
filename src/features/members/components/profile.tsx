...
export const Profile = ({ memberId, onClose } : ProfileProps) => {
    ...
    // For to check the member role and others...
    ...
    if(!member) {
        return (
            <div className="h-full flex flex-col">
                ...
                {/* Incase the member profile is not available while the profile opened */}
                <div className="flex flex-col gap-y-2 h-full items-center justify-center">
            ...
            <div className="h-full flex flex-col">
                    ...
                    <div className="flex flex-col items-center justify-center p-4">
                        <Avatar className="max-w-[256px] max-h-[256px] size-full rounded-md mr-1">
                            ...
                            <AvatarFallback className="aspect-square text-6xl rounded-md bg-red-500 text-white">
                                {avatarFallback}
                            </AvatarFallback>
                        </Avatar>
                    </div>
